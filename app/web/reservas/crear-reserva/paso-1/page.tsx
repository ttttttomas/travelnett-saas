...
export default function Paso1Page() {
  const [tipoReserva, setTipoReserva] = useState<"tradicional" | "bloqueo">(
    "tradicional",
  );
  ...
  return (
    <Container>
      ...
      <div className="max-w-2xl mx-auto w-full mt-5 flex flex-col items-center gap-5">
        {/* Step Tabs */}
        <div className="flex w-full rounded-2xl bg-[#5782F7] overflow-hidden shadow-md shadow-black/20">
          <div className="flex-1 bg-primary rounded-t-2xl text-white text-center py-2.5 font-semibold text-sm md:text-base">
            1. Paquete
          </div>
          <div className="flex-1 bg-[#A8B8F0] text-white text-center py-2.5 font-semibold text-sm md:text-base">
            2. Habitación
          </div>
          <div className="flex-1 bg-[#A8B8F0] text-white text-center py-2.5 font-semibold text-sm md:text-base">
            3. Datos
        ...
        <form className="flex flex-col w-full gap-4">
          ...
          <div className="flex items-center gap-8 mt-1">
            ...
            <label className="flex items-center gap-2 cursor-pointer text-black font-medium">
              <input
                ...
                onChange={() => setTipoReserva("bloqueo")}
                className="w-5 h-5 accent-primary"
              />
              Bloqueo/Grupo
            </label>
          ...
          {tipoReserva === "tradicional" && (
            <div className="flex flex-col gap-2 mt-1">
              <button
                type="button"
                className="flex items-center gap-2 text-black font-medium text-sm md:text-base">
