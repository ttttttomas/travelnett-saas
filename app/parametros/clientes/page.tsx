...
export default function ClientesPage() {
  ...
  const clientes = [
    { id: 1, nombre: "Pablo", last_name: "Perez" },
    { id: 2, nombre: "Pablo", last_name: "Perez" },
    { id: 3, nombre: "Pablo", last_name: "Perez" },
    { id: 4, nombre: "Pablo", last_name: "Perez" },
  ];
  ...
  return (
    <Container>
      ...
      <div className="flex justify-center flex-col items-center mb-6">
        <button className="flex items-center gap-2  text-primary font-semibold px-4 py-2 rounded-lg">
          <svg
            width="22"
            height="22"
            viewBox="0 0 22 22"
