...
export default function ExcursionesPage() {
  ...
  const excursiones = [
    { id: 1, nombre: "Tren del Cielo"},
    { id: 2, nombre: "Tren del Cielo"},
    { id: 3, nombre: "Tren del Cielo"},
    { id: 4, nombre: "Tren del Cielo"},
    { id: 5, nombre: "Tren del Cielo"},
];

  const excursionesFiltered = excursiones
