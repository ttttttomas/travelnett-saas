...
export default function PeriodosPage() {
  ...
  const tipos = [
    { id: 1, nombre: "Vacaciones de Invierno 2025" },
    { id: 2, nombre: "FSL Agosto" },
    { id: 4, nombre: "Segundo Semestre 2025" },
    { id: 5, nombre: "MiniTurismo" },
  ];

  const tiposFiltered = tipos.filter((e) =>
